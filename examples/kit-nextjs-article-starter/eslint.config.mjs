...
const eslintConfig = [
  ...
  ...compat.extends("next/core-web-vitals", "next/typescript", "plugin:@typescript-eslint/recommended", "prettier", "plugin:prettier/recommended"),
  { 
    rules: {
  ...
  {
    files: ["**/__tests__/**/*", "**/*.test.ts", "**/*.test.tsx", "**/*.mockProps.ts"],
    rules: {
