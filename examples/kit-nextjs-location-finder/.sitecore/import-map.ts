...
import { Text, useSitecore, Link, RichText, NextImage, withDatasourceCheck, Image, getFieldValue, Placeholder, ServerPlaceholder, CdpHelper } from '@sitecore-content-sdk/nextjs';
...
const importMap = [
  ...
  },
  {
    ...
    exports: [
      { name: 'default', value: AppPlaceholder },
    ]
  },
  {
    module: 'next/link',
